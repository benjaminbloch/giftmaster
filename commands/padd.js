...
module.exports = {
	name: 'padd', // Command name (can be different from the file name)
	description: 'Add an account to a service (premium)⭐.', // Command description displays in the help command
	...
	execute(message, args) {
        ...
        if (!message.member.roles.cache.has(config.stocker)) return message.channel.send(
            new MessageEmbed()
        ...
        const filePath = `${__dirname}/../pstock/${args[0]}.txt`; // Searching for the stock
